-- ============================================================================
-- CAJÁ TALKS - SCHEMA DE INICIALIZAÇÃO RÁPIDA
...
-- Este será linkado automaticamente quando um usuário se cadastrar
...
DO $$
BEGIN
    RAISE NOTICE '✅ Schema do Cajá Talks criado com sucesso!';
